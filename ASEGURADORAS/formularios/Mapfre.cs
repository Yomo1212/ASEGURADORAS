...
{
    public partial class Mapfre : Form
    {
        public Mapfre()
        {
            InitializeComponent();
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var nuevaEntrada = new MapfrePago
                    {
                    ...
                    context.MapfrePagos.Add(nuevaEntrada);
                    context.SaveChanges();
        ...
        private void buttonBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var context = new ASEGURADORAS.Data.ApplicationDbContext())
                {
                    var resultado = context.MapfrePagos.FirstOrDefault(p => p.Carnet == carnetBuscado);
