...
{
    public partial class Abank : Form
    {
        public Abank()
        {
            InitializeComponent();
        ...
        private void textBoxCoPago_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxDeducible_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxPPaciente_TextChanged(object sender, EventArgs e)
        {

        }

        private void textBoxPAseguradora_TextChanged(object sender, EventArgs e)
        {
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var nuevaEntrada = new AbankPago
                    {
                    ...
                    context.AbankPagos.Add(nuevaEntrada);
                    context.SaveChanges();
        ...
        private void buttonBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var context = new ASEGURADORAS.Data.ApplicationDbContext())
                {
                    var resultado = context.AbankPagos.FirstOrDefault(p => p.Carnet == carnetBuscado);
