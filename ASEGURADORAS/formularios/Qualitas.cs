...
{
    public partial class Qualitas : Form
    {
        public Qualitas()
        {
            InitializeComponent();
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var nuevaEntrada = new QualitasPago
                    {
                    ...
                    context.QualitasPagos.Add(nuevaEntrada);
                    context.SaveChanges();
        ...
        private void buttonBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var context = new ASEGURADORAS.Data.ApplicationDbContext())
                {
                    var resultado = context.QualitasPagos.FirstOrDefault(p => p.Carnet == carnetBuscado);
