...
{
    public partial class Acsa : Form
    {
        public Acsa()
        {
            InitializeComponent();
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var context = new ASEGURADORAS.Data.ApplicationDbContext())
                {
                    ...
                    context.AcsaPagos.Add(nuevaEntrada);
                    context.SaveChanges();
        ...
        private void buttonBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var context = new ASEGURADORAS.Data.ApplicationDbContext())
                {
                    var resultado = context.AcsaPagos.FirstOrDefault(p => p.Carnet == carnetBuscado);
